...
%   [labels, numlabels]  = slicomex(grey_img,nC);
%  [labels, numlabels]  = slicmex(grey_img,nC,20);
fprintf(1,'Use %f sec. \n',cputime-t);
fprintf(1,'\t to divide the image into %d superpixels.\n',nC);
% labels=watershed(grey_img,4);
...
figure('position',[500+144 500+144 200 200]);imshow(mat2gray(bmapOnImg),[],'border','tight','initialmagnification','fit');axis normal;
